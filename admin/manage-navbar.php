...
<head>
    ...
    <title>Manage Navbar - Akademi Merdeka</title>
    <!-- Tailwind CSS CDN -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="mt-6 bg-white rounded-lg shadow overflow-hidden">
                            <div class="p-6">
                                <h3 class="text-base font-semibold text-gray-800 mb-2">How to Set Up Your Navigation Menu</h3>
                                <div class="text-sm text-gray-600 space-y-2">
                                    <p><strong>1. Creating a Top-Level Menu Item:</strong> Add a new menu item with no parent selected.</p>
                                    <p><strong>2. Creating a Dropdown Menu:</strong> First create a parent item with URL set to '#', then add child items by selecting the parent from the dropdown.</p>
                                    <p><strong>3. Position Order:</strong> Items with lower position numbers appear first in the menu.</p>
                                    <p><strong>4. URLs:</strong> Use relative paths for local pages (e.g., './about.php') or full URLs for external links (e.g., 'https://example.com').</p>
                                    <p><strong>5. Active Status:</strong> Inactive menu items will not be displayed on the website.</p>
                                </div>
                            </div>
                        </div>
                    </div>
