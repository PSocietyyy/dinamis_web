      ...
      <div class="container">
        ...
        <div class="row pt-45">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="blog-card">
                  ...
                  <div class="content">
                    ...
                    <h3><a href="blog/tips-konversi-kti-menjadi-buku-referensi-book-chapter">Tips Konversi KTI Menjadi Buku Referensi/Buku Chapter</a></h3>
          ...
          <div class="col-lg-12 col-md-12 text-center">
            <div class="pagination-area"><a href="blog-2.html" class="prev page-numbers"><i class='bx bx-left-arrow-alt'></i></a><span class="page-numbers current" aria-current="page">1</span><a href="blog-2.html" class="page-numbers">2</a><a href="blog-2.html" class="page-numbers">3</a><a href="blog-2.html" class="next page-numbers"><i class='bx bx-right-arrow-alt'></i></a></div>
          </div>
          -->
          <div class="col-lg-12 col-md-12 text-center">
            <div class="pagination-area"><span class="page-numbers current" aria-current="page">1</span></div>
          </div>
        </div>
      </div>
    </div>
